...
Generating data for a complex Registration Form
**prompt**
> Generate 10 inputs with different users for testing the registration form with the fields:
Company Name, Company ID, Tax ID, Legal Status, Fields of Business, Registered Office Address, Email, Phone, Address, Bank Reference

**prompt**
> Create mock product listings, user profiles, and transaction data for testing the end-to-end functionality of an online shopping e-commerce platform

**prompt**
> Generating patient records, medical histories, and test results to validate the functionality of a healthcare information system
