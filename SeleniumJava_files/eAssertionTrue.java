...
public class eAssertionTrue {
    ...
    public void testFillEmailFields() {
        ...
        confirmEmailField.sendKeys("example@example.com");
        ...
        Assert.assertTrue(emailValue.equals(confirmEmailValue), "Email and Confirm Email values are not the same.");
    }
